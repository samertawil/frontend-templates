             ...
             <div id="kt_header_menu" class="header-menu header-menu-mobile  header-menu-layout-default ">
                 ...
                 <ul class="menu-nav ">
                             ...
                             <ul class="menu-subnav">
                                 ...
                                 <li class="menu-item  menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
                                     <a href="#" class="menu-link menu-toggle"><span
                                             ...
                                             </svg><!--end::Svg Icon--></span><span class="menu-text">Projects
                     ...
                     <li class="menu-item  menu-item-submenu" data-menu-toggle="click" aria-haspopup="true"><a
                             href="javascript:;" class="menu-link menu-toggle"><span class="menu-text">Features</span><i
                                 class="menu-arrow"></i></a>
                             ...
                             <ul class="menu-subnav">
                                 ...
                                 <li class="menu-item " aria-haspopup="true"><a href="javascript:;"
                                         class="menu-link "><span
                                             ...
                                             class="menu-text">Campaigns</span><span class="menu-label"><span
                                 ...
                                 <li class="menu-item  menu-item-submenu" data-menu-toggle="hover"
                                     aria-haspopup="true"><a href="javascript:;" class="menu-link menu-toggle"><span
                                             ...
                                             </svg><!--end::Svg Icon--></span><span class="menu-text">Deployment
                 ...
                 <div class="dropdown-menu p-0 m-0 dropdown-menu-anim-up dropdown-menu-sm dropdown-menu-right">
                     ...
                     <ul class="navi navi-hover py-4">
                         ...
                         <li class="navi-item active">
                             <a href="#" class="navi-link">
                                 <span class="symbol symbol-20 mr-3">
                                     <img src="  {{ asset('template-assets/metronic7/media/svg/flags/128-spain.svg') }}"
                                         alt="" />
                                 </span>
                         ...
                         <li class="navi-item">
                             <a href="#" class="navi-link">
                                 <span class="symbol symbol-20 mr-3">
                                     <img src=" {{ asset('template-assets/metronic7/media/svg/flags/162-germany.svg') }}"
                                         alt="" />
                                 </span>
                         ...
                         <li class="navi-item">
                             <a href="#" class="navi-link">
                                 <span class="symbol symbol-20 mr-3">
                                     <img src=" {{ asset('template-assets/metronic7/media/svg/flags/063-japan.svg') }}"
                                         alt="" />
                                 </span>
                         ...
                         <li class="navi-item">
                             <a href="#" class="navi-link">
                                 <span class="symbol symbol-20 mr-3">
                                     <img src=" {{ asset('template-assets/metronic7/media/svg/flags/195-france.svg') }}"
                                         alt="" />
                                 </span>
