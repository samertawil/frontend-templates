...
<head>
    ...
    @include('pack::layouts.metronic7.head')
...
<body id="kt_body"
    ...
    <div class="d-flex flex-column flex-root">
        ...
        <div class="d-flex flex-row flex-column-fluid page">
            ...
            <!--begin::Aside-->
            @include('pack::layouts.metronic7.aside')
            <!--end::Aside-->
            ...
            <div class="d-flex flex-column flex-row-fluid wrapper" id="kt_wrapper">
                ...
                <!--begin::Footer-->
                @include('pack::layouts.metronic7.footer')
                <!--end::Footer-->
            </div>
            <!--end::Wrapper-->
        </div>
        ...
        <div class="offcanvas-content pr-5 mr-n5">
            ...
            <div class="d-flex align-items-center mt-5">
                <div class="symbol symbol-100 mr-5">
                    <div class="symbol-label" style="background-image:url('{{asset('template-assets/metronic7/media/users/300_21.jpg')}}')"></div>
            ...
            <div class="offcanvas-wrapper mb-5 scroll-pull">
                ...
                <div class="d-flex align-items-center justify-content-between py-8">
                    ...
                    <a href="#" class="symbol symbol-70 flex-shrink-0">
                        <img src="  {{asset('template-assets/metronic7/media/stock-600x400/img-1.jpg')}}" title="" alt="" />
                ...
                <div class="d-flex align-items-center justify-content-between py-8">
                    ...
                    <a href="#" class="symbol symbol-70 flex-shrink-0">
                        <img src="{{asset('template-assets/metronic7/media/stock-600x400/img-2.jpg')}}" title="" alt="" />
                    </a>
                </div>
                <!--end::Item-->
                ...
                <div class="d-flex align-items-center justify-content-between py-8">
                    ...
                    <a href="#" class="symbol symbol-70 flex-shrink-0">
                        <img src=" {{asset('template-assets/metronic7/media/stock-600x400/img-3.jpg')}}" title="" alt="" />
                ...
                <div class="d-flex align-items-center justify-content-between py-8">
                    ...
                    <a href="#" class="symbol symbol-70 flex-shrink-0">
                        <img src=" {{asset('template-assets/metronic7/media/stock-600x400/img-4.jpg')}}" title="" alt="" />
                ...
                <div class="d-flex align-items-center justify-content-between py-8">
                    ...
                    <a href="#" class="symbol symbol-70 flex-shrink-0">
                        <img src="  {{asset('template-assets/metronic7/media/stock-600x400/img-8.jpg')}}" title="" alt="" />
                ...
                <div class="tab-pane fade show pt-3 pr-5 mr-n5 active" id="kt_quick_panel_logs" role="tabpanel">
                    ...
                    <div class="mb-15">
                        ...
                        <div class="d-flex align-items-center flex-wrap mb-5">
                            <div class="symbol symbol-50 symbol-light mr-5">
                                <span class="symbol-label">
                                    <img src=" {{asset('template-assets/metronic7/media/svg/misc/006-plurk.svg')}}" class="h-50 align-self-center"
                        ...
                        <div class="d-flex align-items-center flex-wrap mb-5">
                            <div class="symbol symbol-50 symbol-light mr-5">
                                <span class="symbol-label">
                                    <img src="  {{asset('template-assets/metronic7/media/svg/misc/015-telegram.svg')}}" class="h-50 align-self-center"
                        ...
                        <div class="d-flex align-items-center flex-wrap mb-5">
                            <div class="symbol symbol-50 symbol-light mr-5">
                                <span class="symbol-label">
                                    <img src="   {{asset('template-assets/metronic7/media/svg/misc/003-puzzle.svg')}}" class="h-50 align-self-center"
                        ...
                        <div class="d-flex align-items-center flex-wrap mb-5">
                            <div class="symbol symbol-50 symbol-light mr-5">
                                <span class="symbol-label">
                                    <img src=" {{asset('template-assets/metronic7/media/svg/misc/005-bebo.svg')}}" class="h-50 align-self-center"
